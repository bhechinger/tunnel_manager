...
//
//     #[instrument]
//     async fn login(&self, request: Request<LoginData>) -> Result<Response<UserData>, Status> {
...
//
//     #[instrument]
//     async fn register(&self, request: Request<LoginData>) -> Result<Response<UserData>, Status> {
